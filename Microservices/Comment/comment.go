...
const student_url = "http://studentMS:8183/students"
const tutor_url = "http://tutorMS:8184/tutors"
...
func main() {
	...
	db, err = sql.Open("mysql", "root:password@tcp(commentDB:8186)/comment_db")
	if err != nil {
		panic(err.Error())
	}
	defer db.Close()
